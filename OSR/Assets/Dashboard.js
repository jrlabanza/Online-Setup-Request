    ...
    case "OSR": //OSR
        ...
        function (data) {
            ...
            $.each(data["pending"], function (i, osr_data) {
                ...
                else if (osr_data.status == "FOR APPROVAL") {
                    color = "background-color: #c2a6ff;";
                    font = "color: #5000ff;";
                }

                if (osr_data.lot_status == "APPROVED") {
                    lot_color = "background-color: #d4edda;";
                    lot_font = "color: #155724;";
                }
                else if (osr_data.lot_status == "DECLINED") {
                    lot_color = "background-color: #f8d7da;";
                    lot_font = "color: #721c24;";
                }
                else
                {
                    lot_color = "background-color: #dee2e6;";
                    lot_font = "color: #black;";
                }
                ...
                pending += "<td data-osr-id='" + osr_data.id + "'>" + forecast + "</td>";
                pending += "<td data-osr-id='" + osr_data.id + "' style ='" + lot_font + " " + lot_color + "'>" + lot + "</td>";
            ...
            $.each(data["archive"], function (i, osr_data) {
                ...
                released += "<td data-osr-id='" + osr_data.id + "'>" + forecast + "</td>";
                released += "<td data-osr-id='" + osr_data.id + "' style ='" + lot_font + " " + lot_color + "'>" + lot + "</td>";
    ...
    case "": //OSR
        ...
        $.post(
            ...
            function (report) {
                ...
                $("#released-count-saturday-qfn").html(report["firstDay"].released);
                $("#released-count-sunday-qfn").html(report["secondDay"].released);
                $("#released-count-monday-qfn").html(report["thirdDay"].released);
                $("#released-count-tuesday-qfn").html(report["fourthDay"].released);
                $("#released-count-wednesday-qfn").html(report["fifthDay"].released);
                $("#released-count-thursday-qfn").html(report["sixthDay"].released);
                $("#released-count-friday-qfn").html(report["seventhDay"].released);
                $("#released-count-qfn").html(report["overall"].released);

                $("#cancelled-count-saturday-qfn").html(report["cancelledFirstDay"].released);
                $("#cancelled-count-sunday-qfn").html(report["cancelledSecondDay"].released);
                $("#cancelled-count-monday-qfn").html(report["cancelledThirdDay"].released);
                $("#cancelled-count-tuesday-qfn").html(report["cancelledFourthDay"].released);
                $("#cancelled-count-wednesday-qfn").html(report["cancelledFifthDay"].released);
                $("#cancelled-count-thursday-qfn").html(report["cancelledSixthDay"].released);
                $("#cancelled-count-friday-qfn").html(report["cancelledSeventhDay"].released);
                $("#cancelled-count-qfn").html(report["cancelledOverall"].released);

            });
        $.post(
            base_url + "Dashboard/report_burnin",
            function (report) {
                $("#released-count-saturday-bi").html(report["firstDay"].released);
                $("#released-count-sunday-bi").html(report["secondDay"].released);
                $("#released-count-monday-bi").html(report["thirdDay"].released);
                $("#released-count-tuesday-bi").html(report["fourthDay"].released);
                $("#released-count-wednesday-bi").html(report["fifthDay"].released);
                $("#released-count-thursday-bi").html(report["sixthDay"].released);
                $("#released-count-friday-bi").html(report["seventhDay"].released);
                $("#released-count-bi").html(report["overall"].released);

                $("#cancelled-count-saturday-bi").html(report["cancelledFirstDay"].released);
                $("#cancelled-count-sunday-bi").html(report["cancelledSecondDay"].released);
                $("#cancelled-count-monday-bi").html(report["cancelledThirdDay"].released);
                $("#cancelled-count-tuesday-bi").html(report["cancelledFourthDay"].released);
                $("#cancelled-count-wednesday-bi").html(report["cancelledFifthDay"].released);
                $("#cancelled-count-thursday-bi").html(report["cancelledSixthDay"].released);
                $("#cancelled-count-friday-bi").html(report["cancelledSeventhDay"].released);
                $("#cancelled-count-bi").html(report["cancelledOverall"].released);
            });
        $(".loader").hide();
        function getADinfo(ffid) {
            $.getJSON('http://phsm01ws014.ad.onsemi.com:2001/api/Employee?',
                {"ffid": ffid},
                function (data) {
