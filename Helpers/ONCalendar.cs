...
namespace Helpers
{
	...
	public static class ONCalendar
	{
		...
		public static Dictionary<string, string> GetByWW (int ww, int year)
		{
            ...
            //string date = wws[ww]["start"].ToString();
            //return wws[ww];
            return wws[ww];
		}

        public static DateTime GetFirstDay(int ww, int year)
        {
            var wws = GetByYear(year);
            var newDate = Convert.ToDateTime(wws[ww]["start"].ToString());
		...
		public static Dictionary<int, Dictionary<string, string>> GetByDate (DateTime inputDate)
		{
            ...
            //startAndEnd.Add("secondDay", inputDate.StartOfWeek(DayOfWeek.Sunday).ToString("yyyy-MM-dd"));
            //startAndEnd.Add("thirdDay", inputDate.StartOfWeek(DayOfWeek.Monday).ToString("yyyy-MM-dd"));
            //startAndEnd.Add("fourthDay", inputDate.StartOfWeek(DayOfWeek.Tuesday).ToString("yyyy-MM-dd"));
            //startAndEnd.Add("fifthDay", inputDate.StartOfWeek(DayOfWeek.Wednesday).ToString("yyyy-MM-dd"));
            //startAndEnd.Add("sixthDay", inputDate.StartOfWeek(DayOfWeek.Thursday).ToString("yyyy-MM-dd"));
